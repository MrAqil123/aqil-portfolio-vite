...
export const services = [
  {
    ...
    icon: <Icon icon="mdi:bug" className="text-3xl xl:text-light-mode-a!  md:text-white text-white" />,
    id:1,
  ...
  },
  {
    ...
    icon: <Icon icon="ic:baseline-design-services" className="text-3xl xl:text-light-mode-a! md:text-white text-white" />,
    id:2,
  ...
  },
  {
    ...
    icon: <Icon icon="teenyicons:code-outline" className="text-3xl xl:text-light-mode-a! md:text-white text-white" />,
    id:3,
  ...
  },
  {
    ...
    icon: <Icon icon="mdi:speedometer" className="text-3xl xl:text-light-mode-a! md:text-white text-white" />,
    id:4,
  ...
  },
  {
    ...
    icon: <Icon icon="mdi:responsive" className="text-3xl xl:text-light-mode-a! md:text-white text-white" />,
    id:5,
